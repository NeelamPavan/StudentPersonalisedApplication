...
def fifo():
    ...
    for k in range(16):
        ...
        if (k == frames):
            ...
            for i in range(cols):
                ...
                for j in range(rows):
                    ss = " " + str(arr[j][i]) + " "
                    Label(root2, text=ss, font="comicsans 24 bold", borderwidth=2, relief=SOLID, bg="white").grid(
                        row=j + 1, column=1 + i)
                root2.update()
                time.sleep(0.8)
            y = rows + 19;
    ...
    Button(root2, text="View Graph", font="comicsans 16 italic", bg="black", fg="white", command=f_graph).grid(row=1,
                                                                                                               column=len(
                                                                                                                   l) + 2)
    ...
    def f_explain():
        ...
        for i in range(cols):
            if (i < frames):
                ...
                Label(ff_root2, text=str(i + 1), font="timesnewroman 14 bold", bg="cyan", fg="red").grid(row=kk,
                                                                                                         column=0)
                ss2 = "Page Fault: "
                ...
                ss2 = "Page Fault: "
                Label(ff_root2, text=ss2, font="timesnewroman 14 bold", bg="cyan", fg="purple").grid(row=kk - 1,
                                                                                                     column=1)
            kk += 1

    Button(root2, text="Explaination", font="comicsans 16 italic", bg="black", fg="white", command=f_explain).grid(
        row=2, column=len(l) + 2)
...
def sc():
        ...
        if (k == sc_frames):
            ...
            for i in range(sc_cols):
                ...
                if (sc_ans[i] == 'F'):
                    ...
                    Label(sc_root, text=sc_tt, font="comicsans 22 italic", bg="cyan", fg="red").grid(row=0,
                                                                                                     column=1 + i)
                for j in range(sc_rows):
                    sc_ss = " " + str(sc_arr[j][i]) + " "
                    Label(sc_root, text=sc_ss, font="comicsans 24 bold", borderwidth=2, relief=SOLID, bg="white").grid(
                        row=j + 1, column=i + 1)
                sc_root.update()
                time.sleep(0.8)
            sc_yy = sc_rows + 19;
    ...
    Button(sc_root, text="View Graph", font="comicsans 16 italic", bg="black", fg="white", command=sc_graph).grid(row=1,
                                                                                                                  column=len(
                                                                                                                      sc_l) + 2)
    ...
    def sc_explain():
        ...
        for i in range(sc_cols):
            if (i < sc_frames):
                ...
                Label(sc_root2, text=str(i + 1), font="timesnewroman 14 bold", bg="cyan", fg="red").grid(row=kk,
                                                                                                         column=0)
                ss2 = "Page Fault: "
                ...
                Label(sc_root2, text=str(i + 1), font="timesnewroman 14 bold", bg="cyan", fg="red").grid(row=kk - 1,
                                                                                                         column=0)
            else:
                ...
                ss2 = "Page Fault: "
                Label(sc_root2, text=ss2, font="timesnewroman 14 bold", bg="cyan", fg="purple").grid(row=kk - 1,
                                                                                                     column=1)
            kk += 1

    Button(sc_root, text="Explaination", font="comicsans 16 italic", bg="black", fg="white", command=sc_explain).grid(
        row=2, column=len(sc_l) + 2)
...
def rp():
    ...
    for k in range(1, 16):
        ...
        if (k == r_frames):
            ...
            for i in range(cols):
                ...
                for j in range(rows):
                    ss = " " + str(answer[i][j]) + " "
                    Label(r_root, text=ss, font="comicsans 24 bold", borderwidth=2, relief=SOLID, bg="white").grid(
                        row=j + 1, column=1 + i)
                r_root.update()
                time.sleep(0.8)
            y = rows + 19;
    ...
    Button(r_root, text="View Graph", font="comicsans 16 italic", bg="black", fg="white", command=r_graph).grid(row=1,
                                                                                                                column=len(
                                                                                                                    r_l) + 2)
    ...
    def r_explain():
        ...
        for i in range(cols):
            if (i < rows):
                ...
                Label(r_root2, text=str(i + 1), font="timesnewroman 14 bold", bg="cyan", fg="red").grid(row=kk,
                                                                                                        column=0)
                ss2 = "Page Fault: "
                ...
                Label(r_root2, text=str(i + 1), font="timesnewroman 14 bold", bg="cyan", fg="red").grid(row=kk - 1,
                                                                                                        column=0)
            else:
                ...
                ss2 = "Page Fault: "
                Label(r_root2, text=ss2, font="timesnewroman 14 bold", bg="cyan", fg="purple").grid(row=kk - 1,
                                                                                                    column=1)
            kk += 1

    Button(r_root, text="Explaination", font="comicsans 16 italic", bg="black", fg="white", command=r_explain).grid(
        row=2, column=len(r_l) + 2)
...
def o():
    ...
    for kk in range(1, 16):
        ...
        if (kk == o_f):
            ...
            for i in range(cols):
                ...
                for j in range(rows):
                    ss = " " + str(o_arr[j][i]) + " "
                    Label(o_root, text=ss, font="comicsans 24 bold", borderwidth=2, relief=SOLID, bg="white").grid(
                        row=j + 1, column=1 + i)
                o_root.update()
                time.sleep(0.8)
            y = rows + 19;
    ...
    Button(o_root, text="View Graph", font="comicsans 16 italic", bg="black", fg="white", command=o_graph).grid(row=1,
                                                                                                                column=len(
                                                                                                                    o_l) + 2)
    ...
    def o_explain():
        ...
        for i in range(len(o_l)):
            if (i < o_f):
                ...
                Label(o_root2, text=str(i + 1), font="timesnewroman 14 bold", bg="cyan", fg="red").grid(row=kk,
                                                                                                        column=0)
                ss2 = "Page Fault: "
                ...
                Label(o_root2, text=str(i + 1), font="timesnewroman 14 bold", bg="cyan", fg="red").grid(row=kk - 1,
                                                                                                        column=0)
            else:
                ...
                ss2 = "Page Fault: "
                Label(o_root2, text=ss2, font="timesnewroman 14 bold", bg="cyan", fg="purple").grid(row=kk - 1,
                                                                                                    column=1)
            kk += 1

    Button(o_root, text="Explaination", font="comicsans 16 italic", bg="black", fg="white", command=o_explain).grid(
        row=2, column=len(o_l) + 2)
...
def lifo():
    ...
    for k in range(1, 16):
        ...
        if (k == l_f):
            ...
            for i in range(cols):
                ...
                for j in range(rows):
                    ss = " " + str(arr[j][i]) + " "
                    Label(l_root, text=ss, font="comicsans 24 bold", borderwidth=2, relief=SOLID, bg="white").grid(
                        row=j + 1, column=1 + i)
                l_root.update()
                time.sleep(0.8)
            y = rows + 19;
    ...
    Button(l_root, text="View Graph", font="comicsans 16 italic", bg="black", fg="white", command=l_graph).grid(row=1,
                                                                                                                column=len(
                                                                                                                    l_l) + 2)
    def l_explain():
        l_root2 = Tk()
        ...
        for i in range(len(l_l)):
            ...
            kk += 1
    Button(l_root, text="Explaination", font="comicsans 16 italic", bg="black", fg="white", command=l_explain).grid(
        row=2, column=len(l_l) + 2)
