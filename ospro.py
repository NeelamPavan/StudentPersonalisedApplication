...
def fcfs(process):
    ...
    for i in range(len(process)):
        print(
            f"{i + 1}\t{process[i].pid}\t{process[i].arrival_time}\t{process[i].burst_time}\t{process[i].completion_time}\t{process[i].turnaround_time}\t{process[i].waiting_time}")
...
def RoundRobin(processes, quantum):
    ...
    for i in range(n):
        print(
            f"{i + 1}\t{processes[i].pid}\t{processes[i].arrival_time}\t{processes[i].burst_time}\t{processes[i].completion_time}\t{processes[i].turnaround_time}\t{processes[i].waiting_time}")
